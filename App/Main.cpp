...
std::vector<std::tuple<std::wstring, std::wstring>> demoNames = {
    ...
    {L"1-4.dem",     L"Little Fire"},
    {L"1-5.dem",     L"Bay's Neck"},
    {L"1-6.dem",     L"Burning Wharf"},
    {L"1-7.dem",     L"Eastreach"},
    {L"1-8.dem",     L"Comely Hearth"},
    ...
    {L"2-7.dem",     L"Rough Field"},
    {L"2-8.dem",     L"Twisty Farm"},
    {L"2-9.dem",     L"Fallow Earth"},
    {L"2-10.dem",    L"Barrow Set"},
    ...
    {L"6-12.5.dem",  L"Ancient Dam Setup"},
    {L"6-13.dem",    L"Ancient Dam"},
    {L"6-13.5.dem",  L"Apex Setup"},
    {L"6-14.dem",    L"Apex"},
    {L"6-14.5.dem",  L"The Stone Tree Setup"},
    {L"6-15.dem",    L"The Stone Tree"},
    {L"6-15.5.dem",  L"The Backbone Setup"},
    {L"6-16.dem",    L"The Backbone"},
    {L"6-16.5.dem",  L"Baby Swan Setup"},
    ...
    {L"6-21.5.dem",  L"The Nursery Setup"},
    ...
    {L"6-27.dem",    L"Plateau Ferry"},
    {L"6-27.5.dem",  L"God Pillar Setup"},
    {L"6-28.dem",    L"God Pillar"},
    {L"6-final.dem", L"Final cleanup"},
};
